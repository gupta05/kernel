...
int wcnss_change_smsm_state(unsigned, u32, u32);
...
enum {
    WCNSS_SMD_EVENT_OPEN,
    WCNSS_SMD_EVENT_DATA,
    WCNSS_SMD_EVENT_CLOSE,
    WCNSS_SMD_EVENT_STATUS,
    WCNSS_SMD_EVENT_REOPEN_READY,
};
